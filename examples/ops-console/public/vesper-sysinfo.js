(function () {
    ...
    window.vesper.sysinfo = {
         ...
         */
        snapshot: function () {
            return window.vesper.invoke("sysinfo:snapshot", {});
        },
        /**
         * Stream readings as sysinfo:tick events.
         *
        ...
        subscribe: function (options) {
            ...
            return window.vesper.invoke("sysinfo:subscribe", {
                interval: opts.interval || 2
            }).then(function () {
                return {
                    unsubscribe: function () {
                        if (unsub) unsub();
                        return window.vesper.invoke("sysinfo:unsubscribe", {});
                    }
                };
            });
        },
